 ...
 * Инкапсулирует все операции по доступу к данным: получение, добавление, обновление, удаление.
 *
...
class FinanceRepository {
     ...
     *
     * @return Отсортированный по дате (от новых к старым) список всех операций
     */
