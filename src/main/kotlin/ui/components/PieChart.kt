...
/**
 * Компонент круговой диаграммы для визуализации распределения расходов по категориям.
 * Использует Canvas для отрисовки сегментов диаграммы.
 *
 * @param data Карта данных: ключ - название категории, значение - сумма расходов
